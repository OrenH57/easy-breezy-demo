...
export default function Home() { return <>
  <section className="original-hero upgraded-hero">
    <div className="original-hero-copy"><div className="hero-breeze" aria-hidden="true"><i /><i /><i /><i /></div><h1>A fresher home<br />starts with <span>clean air ducts.</span></h1><p className="lede">Professional air duct, dryer vent, and chimney service for homes that deserve clean, comfortable air.</p><div className="hero-points"><span><Sparkles aria-hidden="true" />Clear next steps.</span><span><Heart aria-hidden="true" />Respectful service.</span><span><MapPin aria-hidden="true" />Local coordination.</span></div><div className="hero-actions"><Link className="button original-primary" to="/booking">Get Free Quote <span>→</span></Link><Link className="hero-secondary" to="/services">Explore services</Link></div></div>
